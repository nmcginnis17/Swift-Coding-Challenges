...
print(challenge1b(input: "No duplicates") == true, "Contains no duplicates")
print(challenge1b(input: "abcdefghijklmnopqrstuvwxyz") == true, "Contains no duplicates")
print(challenge1b(input: "AaBbCc") == true, "Contains no duplicates")
print(challenge1b(input: "Hello, world") == false, "Does contain duplicates")
